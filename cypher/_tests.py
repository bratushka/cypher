...
class Tests(TestCase):
    def test_generate_tags(self):
        ...
        big_tuple = tuple(_cypher.generate_tags(27))
...
class ModelTests(TestCase):
    ...
    def test_model_creation_with_props(self):
        class MyModel(_cypher.Model):
            integer = _cypher.Props.Integer()
            floating = _cypher.Props.Float()
            string = _cypher.Props.String()
...
class DBTests(TestCase):
    ...
    def test__get_url_with_invalid_url(self):
        ...
        with self.assertRaises(_cypher.DatabaseAddressException):
            MyDB._get_url()
    ...
    def test_models(self):
        ...
        class MyNode(_cypher.Node):
            pass

        class MyEdge(_cypher.Edge):
            pass
